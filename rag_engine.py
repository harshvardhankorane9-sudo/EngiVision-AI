...
KNOWLEDGE_BASE = [
    ...
    # ---- General / comparison ---------------------------------------------
    {
        "id": "which_branch",
        "text": (
            "Choosing between CSE, CSE-AIML, Mechanical, and ECE depends on your interests. "
            "Choose CSE if you love building software, apps, and backend systems. "
            "Choose CSE-AIML if you love mathematics, statistics, and training intelligent models. "
            "Choose Mechanical if you're passionate about physical systems, design, and manufacturing. "
            "Choose ECE if you're fascinated by circuits, wireless systems, and embedded hardware. "
            "The best branch is the one that matches your genuine interests — not just salary."
        ),
        "tags": ["comparison", "which branch", "cse vs ece", "mechanical vs cse", "choose"]
    },
    {
        "id": "gate_exam",
        "text": (
