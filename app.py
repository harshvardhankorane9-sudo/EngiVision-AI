...
BRANCH_EMOJI = {"CSE": "💻", "CSE-AIML": "🤖", "MECH": "⚙️", "ECE": "🔌"}
BRANCH_NAMES = {
...
with st.sidebar:
    ...
    st.caption("Engineering branch counsellor — Pune & Maharashtra")
    st.divider()
...
# ═════════════════════════════════════════════════════════════════════════════
    ...
    try:
        import plotly.graph_objects as go
        from skill_mapper import BRANCH_PROFILES
...
# ─────────────────────────────────────────────────────────────────────────────
st.divider()
st.caption("🎓 Career Intelligence Engine  |  CSE · CSE-AIML · Mechanical · Electronics")
